...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-[960px] bg-background/70 backdrop-blur-md border border-border/40 rounded-[28px] shadow-lg"
    >
